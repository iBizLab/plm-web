  ...
  appDEUILogics: [
    ...
    },
    {
      ...
      deuilogicNodes: [
                ...
                deuilogicLinkConds: [
                  {
                    ...
                    dstLogicParamId: 'default',
                    logicType: 'SINGLE',
                    name: 'Default[comment] 值不为空(NotNil)',
                    id: 'default[comment] 值不为空(notnil)',
                  },
                ],
                logicType: 'GROUP',
              },
                    ...
                    deuilogicLinkConds: [
                      {
                        ...
                        dstLogicParamId: 'default',
                        logicType: 'SINGLE',
                        name: 'Default[comment] 值为空(Nil)',
                        id: 'default[comment] 值为空(nil)',
                      },
                      {
                        condOP: 'EQ',
                        dstFieldName: 'comment',
                        ...
                        value: 'undefined',
                        logicType: 'SINGLE',
                        name: 'Default[comment] 等于(=) undefined',
                        id: 'default[comment] 等于(=) undefined',
                      },
                    ],
                    logicType: 'GROUP',
                    name: 'OR',
        ...
        {
          code: "util.message.error('请填写拒绝评审意见!');",
          codeName: 'RAWJSCODE5',
          leftPos: 543,
          logicNodeType: 'RAWJSCODE',
          topPos: 341,
