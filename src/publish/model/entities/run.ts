export default {
  ...
  minorAppDERSs: [
    {
      ...
      parentTextAppDEFieldId: 'case_name',
      rsmode: 2,
    ...
    },
    {
      ...
      parentTextAppDEFieldId: 'plan_name',
      rsmode: 2,
  ...
  codeName2: 'runs',
  requestPaths: [
    'libraries/${library}/test_cases/${test_case}/runs/${run}',
    'libraries/${library}/test_plans/${test_plan}/runs/${run}',
    'projects/${project}/test_plans/${test_plan}/runs/${run}',
