export default {
  ...
  appDEUIActions: [
    ...
    },
    {
      ...
      buttonStyle: 'DEFAULT',
      caption: '版本对比',
      codeName: 'idea_review_content_version_comparison',
      frontAppViewId: 'plmweb.idea_version_comparison_view',
      frontProcessType: 'WIZARD',
      fullCodeName: 'version_idea_review_content_version_comparison',
      navigateParams: [
        {
          key: 'base_version',
          value: 'base_version',
      ...
      tooltip: '版本对比',
      uiactionMode: 'FRONT',
      uiactionTag: 'idea_review_content_version_comparison',
      uiactionType: 'DEUIACTION',
      showBusyIndicator: true,
      noPrivDisplayMode: 2,
      appDataEntityId: 'plmweb.version',
      name: '需求评审内容版本对比',
      id: 'idea_review_content_version_comparison@version',
    },
    {
      actionLevel: 100,
      actionTarget: 'SINGLEDATA',
