export default {
  ...
  codeName2: 'comments',
  requestPaths: [
    'libraries/${library}/test_cases/${test_case}/runs/${run}/comments/${comment}',
    'libraries/${library}/test_plans/${test_plan}/runs/${run}/comments/${comment}',
    'projects/${project}/test_plans/${test_plan}/runs/${run}/comments/${comment}',
    'discuss_topics/${discuss_topic}/discuss_posts/${discuss_post}/discuss_replies/${discuss_reply}/comments/${comment}',
    'shared_spaces/${shared_space}/article_pages/${article_page}/comments/${comment}',
    'spaces/${space}/article_pages/${article_page}/comments/${comment}',
    'test_cases/${test_case}/runs/${run}/comments/${comment}',
    'test_plans/${test_plan}/runs/${run}/comments/${comment}',
    'products/${product}/customers/${customer}/comments/${comment}',
    'discuss_topics/${discuss_topic}/discuss_posts/${discuss_post}/comments/${comment}',
    'discuss_posts/${discuss_post}/discuss_replies/${discuss_reply}/comments/${comment}',
