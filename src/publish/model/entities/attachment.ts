export default {
  ...
  requestPaths: [
    'spaces/${space}/stencils/${stencil}/attachments/${attachment}',
    'discuss_topics/${discuss_topic}/discuss_posts/${discuss_post}/attachments/${attachment}',
    'products/${product}/ideas/${idea}/attachments/${attachment}',
    'shared_spaces/${shared_space}/article_pages/${article_page}/attachments/${attachment}',
    'spaces/${space}/article_pages/${article_page}/attachments/${attachment}',
    'libraries/${library}/test_cases/${test_case}/attachments/${attachment}',
    'products/${product}/tickets/${ticket}/attachments/${attachment}',
    'projects/${project}/work_items/${work_item}/attachments/${attachment}',
