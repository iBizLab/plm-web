export default {
  ...
  minorAppDERSs: [
    {
      ...
      parentTextAppDEFieldId: 'sprint_name',
      rsmode: 2,
    ...
    },
    {
      ...
      parentTextAppDEFieldId: 'work_item_title',
      rsmode: 2,
  ...
  requestPaths: [
    'projects/${project}/sprints/${sprint}/sprint_alterations/${sprint_alteration}',
    'projects/${project}/work_items/${work_item}/sprint_alterations/${sprint_alteration}',
