export default {
  ...
  deviewId: '4C2DB46D-C289-4616-ACD7-2F487BE08128',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.WORK_ITEM',
  },
  caption: '工作项',
  codeName: 'work_item_not_add_pick_up_grid_view_review',
  ...
  controls: [
    {
      ...
      controlType: 'GRID',
      logicName: '评审工作项多项选择表格',
      appDataEntityId: 'plmweb.work_item',
      controlParam: {
        id: 'grid',
      },
      modelId: '0b1da8fa39f1219152d7aa06fdbc55b8',
      modelType: 'PSDEGRID',
      name: 'grid',
      id: 'plmweb.work_item.review_mpick_up_grid',
    },
    {
      groupMode: 'SINGLE',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'd82d0e8a6507522ebba5b7f8d98b2ee3',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemnot_add_pick_up_grid_view_review',
  id: 'plmweb.work_item_not_add_pick_up_grid_view_review',
};
