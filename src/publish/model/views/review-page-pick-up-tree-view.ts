export default {
  ...
  loadDefault: true,
  deviewCodeName: 'page_pick_up_tree_view',
  deviewId: '8ac29c7c080cc00a1ddc45c6e93e603f',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
      ...
      controlParam: {},
      name: 'captionbar',
      id: 'page_pick_up_tree_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '5039c5830b6d9b134c76e4badae176e2',
  modelType: 'PSAPPDEVIEW',
  name: 'reviewpage_pick_up_tree_view',
