export default {
  ...
  loadDefault: true,
  deviewCodeName: 'work_item_grid_view_all',
  deviewId: 'bdcf027762e89d184ba505e56941b39b',
  accUserMode: 2,
  capLanguageRes: {
  ...
  appViewParams: [
    {
      key: 'PROPERTYMAP',
      value: 'show_identifier:work_item.show_identifier,title:title',
      name: 'PROPERTYMAP',
      id: 'propertymap',
    },
  ],
    ...
    controls: [
      {
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'grid',
        codeName: 'work_item_grid_view_all_toolbar',
        controlType: 'TOOLBAR',
        ...
        name: 'toolbar',
        id: 'work_item_grid_view_all_toolbar',
      },
      {
        aggMode: 'NONE',
        ...
        controls: [
          {
            ...
            codeName: 'work_item_grid_view_all_grid_batchtoolbar',
            controlType: 'TOOLBAR',
            logicName: '批操作工具栏',
            appDataEntityId: 'plmweb.review_content',
            controlParam: {
            ...
            id: 'work_item_grid_view_all_grid_batchtoolbar',
          },
        ],
        codeName: 'work_item_wf_no_check_grid',
        controlType: 'GRID',
        logicName: '工作项工作流评审内容表格_无复选框',
        appDataEntityId: 'plmweb.review_content',
        controlLogics: [
          {
            eventNames: 'onLoadSuccess',
        ...
        modelId: '267b93a1b8c40f9ddbb49919b9b95c60',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.review_content.work_item_wf_no_check_grid',
      },
      {
        groupMode: 'SINGLE',
        quickSearchMode: 1,
      ...
      },
      {
        ...
        caption: '评审内容',
        codeName: 'work_item_grid_view_all_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.review_content',
        controlParam: {},
        name: 'captionbar',
        id: 'work_item_grid_view_all_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '2dbde9823b4919779711c23f6aca2b18',
  modelType: 'PSAPPDEVIEW',
  name: 'review_contentwork_item_grid_view_all',
