export default {
  ...
  loadDefault: true,
  deviewCodeName: 'idea_tree_exp_view',
  deviewId: '7078a298d19954b96e1269b9a20d8e37',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.REVIEW.TREE_EXP_VIEW',
  },
  caption: '评审',
  codeName: 'review_idea_tree_exp_view',
  ...
  controls: [
      ...
      controls: [
        {
          ...
          detreeNodes: [
            ...
            },
            {
              ...
              decontextMenu: {
                detoolbarItems: [
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_idea_tree_exp_view_node10_cm_deuiaction1_click@review',
                  ...
                  },
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_idea_tree_exp_view_node10_cm_deuiaction2_click@review',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '删除',
                    itemType: 'DEUIACTION',
                ...
                codeName: 'idea_tree_exp_view_node10_cm',
                ...
                name: 'node_10_cm',
                id: 'idea_tree_exp_view_node10_cm',
              },
              navigateParams: [
                {
                  key: 'n_principal_type_eq',
            ...
            },
            {
              ...
              decontextMenu: {
                detoolbarItems: [
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_idea_tree_exp_view_node8_cm_deuiaction1_click@review',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '编辑',
                    itemType: 'DEUIACTION',
                  ...
                  },
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_idea_tree_exp_view_node8_cm_deuiaction2_click@review',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '删除',
                    itemType: 'DEUIACTION',
                ...
                codeName: 'idea_tree_exp_view_node8_cm',
                controlType: 'CONTEXTMENU',
                logicName: '树节点上下文菜单',
                appDataEntityId: 'plmweb.review',
                controlParam: {
                ...
                modelType: 'PSDETOOLBAR',
                name: 'node_8_cm',
                id: 'idea_tree_exp_view_node8_cm',
              },
              sysImage: {
            ...
            },
            {
              ...
              decontextMenu: {
                detoolbarItems: [
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_idea_tree_exp_view_node9_cm_deuiaction1_click@review',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '编辑',
                    itemType: 'DEUIACTION',
                  ...
                  },
                  {
                    ...
                    noPrivDisplayMode: 2,
                    uiactionId:
                      'toolbar_idea_tree_exp_view_node9_cm_deuiaction2_click@review',
                    uiactionTarget: 'SINGLEDATA',
                    valid: true,
                    caption: '删除',
                    itemType: 'DEUIACTION',
                ...
                codeName: 'idea_tree_exp_view_node9_cm',
                controlType: 'CONTEXTMENU',
                logicName: '树节点上下文菜单',
                appDataEntityId: 'plmweb.review',
                controlParam: {
                ...
                modelType: 'PSDETOOLBAR',
                name: 'node_9_cm',
                id: 'idea_tree_exp_view_node9_cm',
              },
              navigateParams: [
                {
                  key: 'n_principal_type_eq',
          ...
          codeName: 'idea_tree_exp_view_tree_view',
          ...
          modelId: 'f2e4218bb2750655367ef12d315abae0',
          modelType: 'PSDETREEVIEW',
          name: 'treeexpbar_tree',
          id: 'plmweb.review.idea_tree_exp_view_tree_view',
        },
        {
          detoolbarItems: [
            {
              ...
              detoolbarItems: [
                {
                  ...
                  noPrivDisplayMode: 2,
                  uiactionId:
                    'toolbar_idea_tree_exp_view_treeexpbar_toolbar_deuiaction1_click@review',
                  uiactionTarget: 'SINGLEDATA',
                  valid: true,
                  caption: '新建分组',
                  itemType: 'DEUIACTION',
                ...
                },
                {
                  ...
                  noPrivDisplayMode: 2,
                  uiactionId:
                    'toolbar_idea_tree_exp_view_treeexpbar_toolbar_deuiaction2_click@review',
                  uiactionTarget: 'SINGLEDATA',
                  valid: true,
                  caption: '新建类别',
                  itemType: 'DEUIACTION',
          ...
          toolbarStyle: 'USER',
          codeName: 'idea_tree_exp_view_treeexpbar_toolbar',
          controlType: 'TOOLBAR',
          logicName: '树上新建刷新工具栏',
          appDataEntityId: 'plmweb.review',
          controlParam: {
          ...
          id: 'idea_tree_exp_view_treeexpbar_toolbar',
        },
      ],
      codeName: 'idea_tree_exp_view_treeexpbar',
      controlType: 'TREEEXPBAR',
      appDataEntityId: 'plmweb.review',
      controlParam: {
        id: 'treeexpbar',
      },
      modelId: 'fe3ab8b0b45169041406ba9acf2dbe9b_treeexpbar',
      modelType: 'PSEXPBAR',
      name: 'treeexpbar',
      id: 'idea_tree_exp_view_treeexpbar',
    },
    {
      groupMode: 'SINGLE',
      quickSearchMode: 1,
    ...
    },
    {
      ...
      caption: '评审',
      codeName: 'idea_tree_exp_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.review',
      controlParam: {},
      name: 'captionbar',
      id: 'idea_tree_exp_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'fe3ab8b0b45169041406ba9acf2dbe9b',
  modelType: 'PSAPPDEVIEW',
  name: 'reviewidea_tree_exp_view',
  id: 'plmweb.review_idea_tree_exp_view',
};
