export default {
  ...
  deviewCodeName: 'work_item_main_view',
  deviewId: 'b1d95f2af0353806a4ec98421fea2d5f',
  accUserMode: 2,
  capLanguageRes: {
    ...
    controls: [
      {
        detoolbarItems: [
            ...
            controlLogics: [
              {
                ...
                logicType: 'SCRIPT',
                scriptCode:
                  "(data.state == '10'||data.state=='50')&&(context.curstage_id == null)&&(data.create_man == context.srfuserid)&&(data.type == 'TEST_CASE')",
            ...
            controlLogics: [
              {
                ...
                logicType: 'SCRIPT',
                scriptCode:
                  "(data.state == '20')&&(data.create_man == context.srfuserid)",
                triggerType: 'ITEMVISIBLE',
                id: 'deuiaction2',
              },
            ],
          ...
          },
          {
            actionLevel: 100,
            noPrivDisplayMode: 2,
            uiactionId: 'add_idea_review_content@review',
            uiactionTarget: 'NONE',
            valid: true,
            caption: '添加内容',
            itemType: 'DEUIACTION',
            controlLogics: [
              {
                ...
                logicType: 'SCRIPT',
                scriptCode:
                  "(data.state == '10'||data.state=='50')&&(context.curstage_id == null)&&(data.create_man == context.srfuserid)&&(data.type == 'IDEA')",
                triggerType: 'ITEMVISIBLE',
                id: 'idea',
              },
            ],
          ...
          },
          {
            actionLevel: 100,
            noPrivDisplayMode: 2,
            uiactionId: 'add_work_item_review_content@review',
            uiactionTarget: 'NONE',
            valid: true,
            caption: '添加内容',
            itemType: 'DEUIACTION',
            controlLogics: [
              {
                ...
                logicType: 'SCRIPT',
                scriptCode:
                  "(data.state == '10'||data.state=='50')&&(context.curstage_id == null)&&(data.create_man == context.srfuserid)&&(data.type == 'WORK_ITEM')",
                triggerType: 'ITEMVISIBLE',
                id: 'work_item',
              },
            ],
          ...
          },
          {
            actionLevel: 100,
            noPrivDisplayMode: 2,
            uiactionId: 'add_page_review_content@review',
            uiactionTarget: 'NONE',
            valid: true,
            caption: '添加内容',
            itemType: 'DEUIACTION',
            controlLogics: [
              {
                ...
                logicType: 'SCRIPT',
                scriptCode:
                  "(data.state == '10'||data.state=='50')&&(context.curstage_id == null)&&(data.create_man == context.srfuserid)&&(data.type == 'PAGE')",
                triggerType: 'ITEMVISIBLE',
                id: 'page',
              },
            ],
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'form',
        codeName: 'work_item_main_view_toolbar',
        controlType: 'TOOLBAR',
        logicName: '评审主视图_工具栏',
        appDataEntityId: 'plmweb.review',
        controlParam: {
        ...
        name: 'toolbar',
        id: 'work_item_main_view_toolbar',
      },
      {
        createControlAction: {
        ...
        showBusyIndicator: true,
        codeName: 'work_item_main_view_form',
        controlType: 'FORM',
        logicName: '工作项评审主视图_表单',
        appDataEntityId: 'plmweb.review',
        controlLogics: [
          {
            eventNames: 'onLoadSuccess',
        ...
        modelId: '620ed1c5f40873075c59cf26e60484ff',
        modelType: 'PSDEFORM_EDITFORM',
        name: 'form',
        id: 'plmweb.review.work_item_main_view_form',
      },
      {
        codeName: 'work_item_main_view_datainfobar',
        ...
        name: 'datainfobar',
        id: 'work_item_main_view_datainfobar',
      },
      {
        capLanguageRes: {
          lanResTag: 'PAGE.CAPTION.REVIEW.MAIN_VIEW',
        ...
        caption: '评审',
        codeName: 'work_item_main_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.review',
        controlParam: {},
        name: 'captionbar',
        id: 'work_item_main_view_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '1190ffb32d3e8d95e4aec8c494a785a0',
  modelType: 'PSAPPDEVIEW',
  name: 'reviewwork_item_main_view',
