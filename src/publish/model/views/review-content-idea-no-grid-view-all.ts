export default {
  ...
  loadDefault: true,
  deviewCodeName: 'idea_no_grid_view_all',
  deviewId: '8ce423ee0265114262e6e7f17c641a63',
  accUserMode: 2,
  capLanguageRes: {
  ...
  appViewParams: [
    {
      key: 'PROPERTYMAP',
      value: 'show_identifier:idea.show_identifier,title:title',
      name: 'PROPERTYMAP',
      id: 'propertymap',
    },
  ],
    ...
    controls: [
      {
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'grid',
        codeName: 'idea_no_grid_view_all_toolbar',
        controlType: 'TOOLBAR',
        ...
        name: 'toolbar',
        id: 'idea_no_grid_view_all_toolbar',
      },
      {
        aggMode: 'NONE',
        ...
        controls: [
          {
            ...
            codeName: 'idea_no_grid_view_all_grid_batchtoolbar',
            controlType: 'TOOLBAR',
            logicName: '批操作工具栏',
            appDataEntityId: 'plmweb.review_content',
            controlParam: {
            ...
            id: 'idea_no_grid_view_all_grid_batchtoolbar',
          },
        ],
        codeName: 'idea_no_grid_view_all_grid',
        controlType: 'GRID',
        logicName: '需求评审内容表格（无多选）',
        appDataEntityId: 'plmweb.review_content',
        controlLogics: [
          {
            eventNames: 'onLoadSuccess',
        ...
        modelId: '3ac6e0792d3adaf6601b309f30aba7a7',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.review_content.idea_no_grid_view_all_grid',
      },
      {
      ...
      },
      {
        ...
        caption: '评审内容',
        codeName: 'idea_no_grid_view_all_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.review_content',
        controlParam: {},
        name: 'captionbar',
        id: 'idea_no_grid_view_all_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'fb2368e975f0777fbda0776328f71d83',
  modelType: 'PSAPPDEVIEW',
  name: 'review_contentidea_no_grid_view_all',
