export default {
  ...
  loadDefault: true,
  deviewCodeName: 'page_grid_view_all',
  deviewId: 'f4ad60dd1ffd5a708e11286c3a800fe1',
  accUserMode: 2,
  capLanguageRes: {
  ...
  appViewParams: [
    {
      key: 'PROPERTYMAP',
      value: 'show_identifier:page.show_identifier,title:page.name',
      name: 'PROPERTYMAP',
      id: 'propertymap',
    },
  ],
    ...
    controls: [
      {
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'grid',
        codeName: 'page_grid_view_all_toolbar',
        controlType: 'TOOLBAR',
      ...
      },
      {
        ...
        controls: [
          {
            ...
            codeName: 'page_grid_view_all_grid_batchtoolbar',
            controlType: 'TOOLBAR',
            logicName: '批操作工具栏',
            appDataEntityId: 'plmweb.review_content',
            controlParam: {
            ...
            id: 'page_grid_view_all_grid_batchtoolbar',
          },
        ],
        codeName: 'page_wf_no_check_grid',
        controlType: 'GRID',
        logicName: '页面工作流评审内容表格_无复选框',
        appDataEntityId: 'plmweb.review_content',
        controlLogics: [
          {
            eventNames: 'onLoadSuccess',
        ...
        modelId: 'e14af652837925607065a274927a14e8',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.review_content.page_wf_no_check_grid',
      },
      {
        groupMode: 'SINGLE',
        quickSearchMode: 1,
      ...
      },
      {
        ...
        caption: '评审内容',
        codeName: 'page_grid_view_all_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.review_content',
        controlParam: {},
        name: 'captionbar',
        id: 'page_grid_view_all_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '0f8af2ee2a24d46490c6aeadb762aba1',
  modelType: 'PSAPPDEVIEW',
  name: 'review_contentpage_grid_view_all',
