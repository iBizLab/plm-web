export default {
  ...
  loadDefault: true,
  deviewCodeName: 'work_item_no_grid_view_all',
  deviewId: 'c55cd7ac1cc3988c123d34dfa466da95',
  accUserMode: 2,
  capLanguageRes: {
    ...
    controls: [
      {
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'grid',
        codeName: 'work_item_no_grid_view_all_toolbar',
        controlType: 'TOOLBAR',
        ...
        name: 'toolbar',
        id: 'work_item_no_grid_view_all_toolbar',
      },
      {
        aggMode: 'NONE',
        ...
        controls: [
          {
            ...
            id: 'work_item_no_grid_view_all_grid_batchtoolbar',
          },
        ],
        codeName: 'work_item_all_grid',
        controlType: 'GRID',
        logicName: '工作项评审内容表格',
        appDataEntityId: 'plmweb.review_content',
        controlLogics: [
        ...
        modelId: '966aa8854c04412ad3f1783cf67c6902',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.review_content.work_item_all_grid',
      },
      {
      ...
      },
      {
        ...
        caption: '评审内容',
        codeName: 'work_item_no_grid_view_all_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.review_content',
        controlParam: {},
        name: 'captionbar',
        id: 'work_item_no_grid_view_all_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'd3bae59f547baa23c28a6b8143d89234',
  modelType: 'PSAPPDEVIEW',
  name: 'review_contentwork_item_no_grid_view_all',
