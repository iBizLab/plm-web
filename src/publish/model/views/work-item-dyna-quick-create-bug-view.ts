export default {
  ...
  loadDefault: true,
  openMode: 'POPUPMODAL',
  deviewCodeName: 'dyna_quick_create_bug_view',
  deviewId: 'B0412D4A-EEAC-4C79-AACC-5C15484A5262',
  accUserMode: 2,
  capLanguageRes: {
    ...
    controls: [
      {
        ...
        deformItemUpdates: [
          ...
          },
          {
            ...
            scriptCode:
              "// 每次设置缺陷类型前手动置空工作项类型数据，使得表单项更新后必定触发类型变更\r\nctrl.state.data.work_item_type_id = null;\r\nctrl.state.data.work_item_type_name = null;\r\n\r\n// 调用表单项更新设置缺陷类型\r\nconst params = { ...ctrl.params, ...ctrl.data.getOrigin() };\r\n\r\nconst res = await ctrl.service.updateFormItem(\r\n    'set_type_bug',\r\n    ctrl.context,\r\n    params,\r\n);\r\n\r\nreturn res.data\r\n",
            customCode: true,
            showBusyIndicator: true,
            name: '设置缺陷类型',
            id: 'set_type_bug',
                ...
                deformDetails: [
                        ...
                        defdlogics: [
                          {
                            ...
                            defdlogics: [
                              ...
                              },
                              {
                                ...
                                logicType: 'SINGLE',
                                name: 'dynamic_new值不为空(NotNil)',
                                id: 'dynamic_new值不为空(notnil)',
                              },
                            ],
                            logicType: 'GROUP',
                            name: 'OR',
                  ...
                  },
                  {
                    ...
                    editor: {
                      ...
                      editorParams: {
                        'SRFNAVPARAM.n_code_in': '%children_work_item_type_id%',
                        'SRFNAVPARAM.N_GROUP_EQ': '%work_item_type_group_bug%',
                        ...
                        defdlogics: [
                          {
                            ...
                            logicType: 'SINGLE',
                            name: 'project_name值不为空(NotNil)',
                            id: 'project_name值不为空(notnil)',
                          },
                        ],
                        logicType: 'GROUP',
                      },
                                ...
                                defdlogics: [
                                  {
                                    ...
                                    value: 'scrum_task',
                                    logicType: 'SINGLE',
                                    id: 'work_item_type_id等于(=) scrum_task',
                                  },
                                  {
                                    condOP: 'EQ',
                                    defdname: 'work_item_type_id',
                                    ...
                                    logicType: 'SINGLE',
                                    id: 'work_item_type_id等于(=) waterfall_task',
                                  },
                                  {
                                    condOP: 'EQ',
                                    defdname: 'work_item_type_id',
                                    value: 'kanban_task',
                                    logicType: 'SINGLE',
                                    id: 'work_item_type_id等于(=) kanban_task',
                                  },
                                ],
                                logicType: 'GROUP',
                                name: 'OR',
                                ...
                                defdlogics: [
                                  {
                                    ...
                                    defdname: 'multiple_people',
                                    logicType: 'SINGLE',
                                    name: 'multiple_people值为空(Nil)',
                                    id: 'multiple_people值为空(nil)',
                                  },
                                  {
                                    condOP: 'EQ',
                                    defdname: 'multiple_people',
                        ...
                        defdlogics: [
                          {
                            ...
                            value: 'requirement',
                            logicType: 'SINGLE',
                            id: 'work_item_type_group等于(=) requirement',
                          },
                        ],
                        logicType: 'GROUP',
                      },
                        ...
                        defdlogics: [
                          {
                            ...
                            value: 'task',
                            logicType: 'SINGLE',
                            id: 'work_item_type_group等于(=) task',
                          },
                        ],
                        logicType: 'GROUP',
                      },
        ...
        deformItemUpdates: [
          {
            ...
            scriptCode:
              "// 每次设置缺陷类型前手动置空工作项类型数据，使得表单项更新后必定触发类型变更\r\nctrl.state.data.work_item_type_id = null;\r\nctrl.state.data.work_item_type_name = null;\r\n\r\n// 调用表单项更新设置缺陷类型\r\nconst params = { ...ctrl.params, ...ctrl.data.getOrigin() };\r\nconst tempContext = Object.assign(ctrl.context,{project:ctrl.data.project_id})\r\nconst res = await ctrl.service.updateFormItem(\r\n    'set_type_bug',\r\n    tempContext,\r\n    params,\r\n);\r\n\r\nreturn res.data\r\n",
            customCode: true,
            showBusyIndicator: true,
            name: '设置缺陷类型',
            id: 'set_type_bug',
                        ...
                        defdlogics: [
                          {
                            ...
                            logicType: 'SINGLE',
                            id: ' view.params.srfparentkey = data.project_id;',
                          },
                        ],
                        logicType: 'GROUP',
                      },
                ...
                deformDetails: [
                  {
                    ...
                    defdgroupLogics: [
                      {
                        logicCat: 'ITEMENABLE',
                        relatedDetailNames: ['dynamic_new'],
                        groupOP: 'AND',
                        defdlogics: [
                          {
                            condOP: 'ISNOTNULL',
      ...
      {
        codeName: 'dyna_quick_create_bug_view_datainfobar',
        ...
        name: 'datainfobar',
        id: 'dyna_quick_create_bug_view_datainfobar',
      },
      {
        capLanguageRes: {
          lanResTag: 'DE.LNAME.WORK_ITEM',
        ...
        caption: '工作项',
        codeName: 'dyna_quick_create_bug_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.work_item',
        controlParam: {},
        name: 'captionbar',
        id: 'dyna_quick_create_bug_view_captionbar',
      },
    ],
    codeName: 'usr0607373617',
    controlType: 'VIEWLAYOUTPANEL',
    logicName: 'dyna_quick_create_bug_view选项操作视图布局面',
    appDataEntityId: 'plmweb.work_item',
    controlParam: {},
    modelId: '79D517AE-8254-4699-A968-26178E8C800A',
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '328dedec35c2e7834dbe34a386991df1',
  modelType: 'PSAPPDEVIEW',
  name: 'work_itemdyna_quick_create_bug_view',
