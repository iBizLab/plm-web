export default {
  openMode: 'POPUPMODAL',
  deviewCodeName: 'page_create_wizard_view',
  deviewId: '87d7275dfb309171ac948bb79c8752bb',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      deeditForms: [
        {
                  ...
                  deformDetails: [
                    ...
                    },
                    {
                      ...
                      editor: {
                        ...
                        editorParams: {
                          'SRFNAVPARAM.N_SCOPE_ID_EQ': '%space%',
                        },
                    ...
                    },
                    {
                      ...
                      editor: {
                        ...
                        singleSelect: true,
                        pickupAppViewId: 'plmweb.review_page_pick_up_tree_view',
                        forceSelection: true,
                        showTrigger: true,
                    ...
                    },
                    {
                      ...
                      editor: {
                        editorParams: {
                          'srfnavparam.n_owner_subtype_eq': 'space_review',
          ...
          modelId: '72ed2368c87c030ed5a984a88c0db110',
          modelType: 'PSDEFORM_EDITFORM',
          name: 'wizardpanel_form_fill_info',
          id: 'plmweb.review_wizard.page_create_form',
        },
        {
          getControlAction: {
            appDEMethodId: 'gettemp',
      ...
      dewizard: {
        ...
        wizardStyle: 'DEFAULT',
        name: '页面评审新建向导',
        id: 'testmgmt.review_wizard.page_create_wizard',
      },
      wizardStyle: 'DEFAULT',
      showActionBar: true,
      showStepBar: true,
      ...
      modelId: '78ad030ea008a838218eeec89eb21303',
      modelType: 'PSDEWIZARDPANEL',
      name: 'wizardpanel',
      id: 'plmweb.review_wizard.page_create_wizard',
    },
    {
      capLanguageRes: {
        lanResTag: 'PAGE.CAPTION.REVIEW.CREATE_WIZARD_VIEW',
      ...
      caption: '新建评审',
      codeName: 'page_create_wizard_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.review_wizard',
      controlParam: {},
      name: 'captionbar',
      id: 'page_create_wizard_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '032dc75bf03a3fd9cd119d5d737fa9fd',
  modelType: 'PSAPPDEVIEW',
  name: 'review_wizardpage_create_wizard_view',
