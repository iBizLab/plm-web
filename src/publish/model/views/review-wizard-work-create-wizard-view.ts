export default {
  openMode: 'POPUPMODAL',
  deviewCodeName: 'work_create_wizard_view',
  deviewId: '91b915bc45ab036f4a3f8187a73edec5',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    {
      ...
      deeditForms: [
        {
                  ...
                  deformDetails: [
                    ...
                    },
                    {
                      ...
                      editor: {
                        ...
                        editorParams: {
                          'SRFNAVPARAM.N_SCOPE_ID_EQ': '%project%',
                        },
                          ...
                          deformDetails: [
                            ...
                            },
                            {
                              ...
                              editor: {
                                ...
                                editorStyle: 'WORK_ITEM_TEAM_SELECT',
                                editorType: 'PICKER',
                    ...
                    },
                    {
                      ...
                      editor: {
                        editorParams: {
                          'srfnavparam.n_owner_subtype_eq': 'project_review',
          ...
          modelId: 'a17e50595fb01228ff9928763eda7f72',
          modelType: 'PSDEFORM_EDITFORM',
          name: 'wizardpanel_form_fill_info',
          id: 'plmweb.review_wizard.work_item_create_form',
        },
        {
          getControlAction: {
            appDEMethodId: 'gettemp',
      ...
      dewizard: {
        codeName: 'work_item_create_wizard',
        ...
        wizardStyle: 'DEFAULT',
        name: '工作项评审新建向导',
        id: 'testmgmt.review_wizard.work_item_create_wizard',
      },
      wizardStyle: 'DEFAULT',
      showActionBar: true,
      showStepBar: true,
      ...
      modelId: 'cf2bbdac76a521f6ec19fa1b5d039e89',
      modelType: 'PSDEWIZARDPANEL',
      name: 'wizardpanel',
      id: 'plmweb.review_wizard.work_item_create_wizard',
    },
    {
      capLanguageRes: {
        lanResTag: 'PAGE.CAPTION.REVIEW.CREATE_WIZARD_VIEW',
      ...
      caption: '新建评审',
      codeName: 'work_create_wizard_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.review_wizard',
      controlParam: {},
      name: 'captionbar',
      id: 'work_create_wizard_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: 'f67af627053f76e2efd4eeb3c780b0aa',
  modelType: 'PSAPPDEVIEW',
  name: 'review_wizardwork_create_wizard_view',
