export default {
  ...
  openMode: 'POPUPMODAL',
  deviewCodeName: 'review_re_idea_view',
  deviewId: '22b9d89e0cfd6c544fcad583aa99f21b',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'PAGE.CAPTION.IDEA.OTHERS_RELATION_IDEA_VIEW',
  },
  caption: '选择需求',
  codeName: 'idea_review_re_idea_view',
  ...
  viewLayoutPanel: {
    ...
    controls: [
      {
        embeddedAppDEViewId: 'plmweb.idea_not_add_pick_up_grid_view_review',
        codeName: 'review_re_idea_view_pickupviewpanel',
        ...
        id: 'review_re_idea_view_pickupviewpanel',
      },
      {
        title: '选择需求',
        ...
        controls: [
          {
            ...
            modelId: '9ecdf398720ca746ddd1792e007dc9cc',
            modelType: 'PSDETREEVIEW',
            name: 'treeexpbar_tree',
            id: 'plmweb.idea.review_re_idea_tree',
          },
        ],
        codeName: 'review_re_idea_view_treeexpbar',
        controlType: 'TREEEXPBAR',
        appDataEntityId: 'plmweb.idea',
        controlParam: {
          id: 'treeexpbar',
        },
        modelId: '85a06c5ec407ec9527a8e14c0456e000_treeexpbar',
        modelType: 'PSEXPBAR',
        name: 'treeexpbar',
        id: 'review_re_idea_view_treeexpbar',
      },
      {
        groupMode: 'NONE',
        groupStyle: 'DEFAULT',
      ...
      },
      {
        ...
        caption: '选择需求',
        codeName: 'review_re_idea_view_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.idea',
        controlParam: {},
        name: 'captionbar',
        id: 'review_re_idea_view_captionbar',
      },
    ],
  ...
  modelId: '85a06c5ec407ec9527a8e14c0456e000',
  modelType: 'PSAPPDEVIEW',
  name: 'ideareview_re_idea_view',
  id: 'plmweb.idea_review_re_idea_view',
};
