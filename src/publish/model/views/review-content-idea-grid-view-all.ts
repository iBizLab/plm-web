export default {
  ...
  loadDefault: true,
  deviewCodeName: 'idea_grid_view_all',
  deviewId: '041b4d056d9e525e247f692bfcd968fe',
  accUserMode: 2,
  capLanguageRes: {
    ...
    controls: [
      {
        ...
        toolbarStyle: 'USER',
        xdataControlName: 'grid',
        codeName: 'idea_grid_view_all_toolbar',
        controlType: 'TOOLBAR',
      ...
      },
      {
        ...
        controls: [
          {
            ...
            id: 'idea_grid_view_all_grid_batchtoolbar',
          },
        ],
        codeName: 'idea_wf_grid_view_no_check_grid',
        controlType: 'GRID',
        logicName: '需求工作流评审内容表格_不复选框',
        appDataEntityId: 'plmweb.review_content',
        controlLogics: [
          {
            eventNames: 'onLoadSuccess',
        ...
        modelId: '4d2a3f5ee3de0e95af2b87b8b5ad0559',
        modelType: 'PSDEGRID',
        name: 'grid',
        id: 'plmweb.review_content.idea_wf_grid_view_no_check_grid',
      },
      {
        groupMode: 'SINGLE',
        quickSearchMode: 1,
      ...
      },
      {
        ...
        caption: '评审内容',
        codeName: 'idea_grid_view_all_captionbar',
        controlType: 'CAPTIONBAR',
        appDataEntityId: 'plmweb.review_content',
        controlParam: {},
        name: 'captionbar',
        id: 'idea_grid_view_all_captionbar',
      },
    ],
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '9f5c77c327e0a74c4b10d6c8d0ed43f9',
  modelType: 'PSAPPDEVIEW',
  name: 'review_contentidea_grid_view_all',
