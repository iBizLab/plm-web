export default {
  ...
  loadDefault: true,
  deviewCodeName: 'product_all_grid_view',
  deviewId: 'e43f62f62def04b312214f7debced7df',
  accUserMode: 2,
  capLanguageRes: {
    lanResTag: 'DE.LNAME.GUIDELINE',
  },
  caption: '评审配置',
  codeName: 'guideline_product_all_grid_view',
  ...
  controls: [
    {
      xdataControlName: 'grid',
      codeName: 'product_all_grid_view_toolbar',
      controlType: 'TOOLBAR',
      ...
      name: 'toolbar',
      id: 'product_all_grid_view_toolbar',
    },
    {
      aggMode: 'NONE',
    ...
    },
    {
      ...
      caption: '评审配置',
      codeName: 'product_all_grid_view_captionbar',
      controlType: 'CAPTIONBAR',
      appDataEntityId: 'plmweb.guideline',
      controlParam: {},
      name: 'captionbar',
      id: 'product_all_grid_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '701a3c72da9dbf9bc31d5861de822996',
  modelType: 'PSAPPDEVIEW',
  name: 'guidelineproduct_all_grid_view',
  id: 'plmweb.guideline_product_all_grid_view',
};
