export default {
  ...
  loadDefault: true,
  deviewCodeName: 'work_item_pick_up_tree_view',
  deviewId: '5d39ea32fa1804bd2b121a041c096543',
  accUserMode: 2,
  capLanguageRes: {
  ...
  controls: [
    ...
    },
    {
      ...
      controlParam: {},
      name: 'captionbar',
      id: 'work_item_pick_up_tree_view_captionbar',
    },
  ],
  viewLayoutPanel: {
    layoutBodyOnly: true,
  ...
  enableDP: true,
  showCaptionBar: true,
  modelId: '9fc116748f80e153e5e7ec1a4e52b611',
  modelType: 'PSAPPDEVIEW',
  name: 'reviewwork_item_pick_up_tree_view',
  id: 'plmweb.review_work_item_pick_up_tree_view',
};
