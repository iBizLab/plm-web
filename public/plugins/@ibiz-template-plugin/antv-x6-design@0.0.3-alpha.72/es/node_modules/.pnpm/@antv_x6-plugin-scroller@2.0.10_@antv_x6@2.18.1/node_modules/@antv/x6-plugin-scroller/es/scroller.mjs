...
import { before, append, appendTo, after } from '../../../../../@antv_x6-common@2.0.16/node_modules/@antv/x6-common/es/dom/elem.mjs';
import { GraphView } from '../../../../../@antv_x6@2.18.1/node_modules/@antv/x6/es/graph/view.mjs';
import { Platform } from '../../../../../@antv_x6-common@2.0.16/node_modules/@antv/x6-common/es/platform/index.mjs';
...
import { prop } from '../../../../../@antv_x6-common@2.0.16/node_modules/@antv/x6-common/es/dom/prop.mjs';
import { normalizeSides, normalizePercentage } from '../../../../../@antv_x6-common@2.0.16/node_modules/@antv/x6-common/es/number/number.mjs';
...
import { Util } from '../../../../../@antv_x6@2.18.1/node_modules/@antv/x6/es/util/index.mjs';
import { BackgroundManager } from '../../../../../@antv_x6@2.18.1/node_modules/@antv/x6/es/graph/background.mjs';
...
class ScrollerImpl extends View {
    get graph() {
    ...
    constructor(options) {
        ...
        this.onUpdate = debounce(this.onUpdate, 200);
        ...
        addClass(this.container, this.prefixClassName(ScrollerImpl.containerClass));
        css(this.container, { width, height });
        if (this.options.pageVisible) {
            addClass(this.container, this.prefixClassName(ScrollerImpl.pagedClass));
        }
        ...
        if (graphContainer.parentNode) {
            before(graphContainer, this.container);
        }
        this.content = document.createElement('div');
        addClass(this.content, this.prefixClassName(ScrollerImpl.contentClass));
        css(this.content, {
        ...
        addClass(this.background, this.prefixClassName(ScrollerImpl.backgroundClass));
        append(this.content, this.background);
        if (!this.options.pageVisible) {
            append(this.content, this.graph.view.grid);
        }
        append(this.content, graphContainer);
        ...
        if (this.options.pageVisible && this.options.pageBreak) {
            ...
            if (graphWidth > pageWidth || graphHeight > pageHeight) {
                ...
                for (let i = 1, l = Math.floor(graphWidth / pageWidth); i < l; i += 1) {
                    ...
                    addClass(div, this.prefixClassName(`graph-pagebreak-vertical`));
                    css(div, { left: i * pageWidth });
                    appendTo(div, container);
                    hasPageBreak = true;
                }
                for (let i = 1, l = Math.floor(graphHeight / pageHeight); i < l; i += 1) {
                    const div = document.createElement('div');
                    addClass(div, this.prefixClassName(`graph-pagebreak-horizontal`));
                    css(div, { top: i * pageHeight });
                    appendTo(div, container);
                    hasPageBreak = true;
                }
                if (hasPageBreak) {
                    addClass(container, this.prefixClassName('graph-pagebreak'));
                    after(this.graph.view.grid, container);
    ...
    scrollbarPosition(left, top) {
        ...
        if (typeof left === 'number') {
            prop$1.scrollLeft = left;
        }
        if (typeof top === 'number') {
            prop$1.scrollTop = top;
        }
        prop(this.container, prop$1);
        return this;
    }
    /**
    ...
    scrollToPoint(x, y) {
        ...
        const prop$1 = {};
        if (typeof x === 'number') {
            prop$1.scrollLeft = x - size.width / 2 + ctm.e + (this.padding.left || 0);
        }
        if (typeof y === 'number') {
            prop$1.scrollTop = y - size.height / 2 + ctm.f + (this.padding.top || 0);
        }
        prop(this.container, prop$1);
        return this;
    }
    ...
    transitionToPoint(x, y, options) {
        ...
        addClass(this.container, ScrollerImpl.transitionClassName);
        Event.off(this.content, ScrollerImpl.transitionEventName);
        Event.on(this.content, ScrollerImpl.transitionEventName, (e) => {
    ...
    removeTransition() {
        removeClass(this.container, ScrollerImpl.transitionClassName);
        Event.off(this.content, ScrollerImpl.transitionEventName);
        css(this.content, {
            transform: '',
            transformOrigin: '',
    ...
    resize(width, height) {
        ...
        css(this.container, { width: w, height: h });
        this.update();
    }
    getClientSize() {
     ...
     */
    lock() {
        css(this.container, { overflow: 'hidden' });
        return this;
    }
    /**
     ...
     */
    unlock() {
        css(this.container, { overflow: 'scroll' });
        return this;
    }
    onRemove() {
        this.stopListening();
    ...
    dispose() {
        before(this.container, this.graph.container);
        this.remove();
    }
}
__decorate([
...
(function (ScrollerImpl) {
    ...
    function getOptions(options) {
        const result = merge({}, ScrollerImpl.defaultOptions, options);
