...
import { Timing } from '../../../../../../@antv_x6-common@2.0.16/node_modules/@antv/x6-common/es/animation/timing.mjs';
...
class Animation {
    ...
    start(path, targetValue, options = {}, delim = '/') {
        ...
        const localOptions = defaults(options, Animation.defaultOptions);
