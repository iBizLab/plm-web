...
import { JobQueue, JOB_PRIORITY } from './queueJob.mjs';
...
import { NodeView } from '../view/node.mjs';
import { EdgeView } from '../view/edge.mjs';
...
class Scheduler extends Disposable {
    ...
    createCellView(cell) {
        ...
        if (createViewHook) {
            const ret = call(createViewHook, this.graph, cell);
            if (ret) {
