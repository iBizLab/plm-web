...
import { append, appendTo, remove } from '../../../../../@antv_x6-common@2.0.16/node_modules/@antv/x6-common/es/dom/elem.mjs';
import { css } from '../../../../../@antv_x6-common@2.0.16/node_modules/@antv/x6-common/es/dom/css.mjs';
import { isAsync, toDeferredBoolean } from '../../../../../@antv_x6-common@2.0.16/node_modules/@antv/x6-common/es/function/async.mjs';
import { offset } from '../../../../../@antv_x6-common@2.0.16/node_modules/@antv/x6-common/es/dom/position.mjs';
import { Rectangle } from '../../../../../@antv_x6-geometry@2.0.5/node_modules/@antv/x6-geometry/es/rectangle.mjs';
import { GeometryUtil } from '../../../../../@antv_x6-geometry@2.0.5/node_modules/@antv/x6-geometry/es/util.mjs';
...
class Dnd extends View {
    ...
    init() {
        ...
        addClass(this.container, this.prefixClassName('widget-dnd'));
        ...
        append(this.container, this.draggingGraph.container);
    }
    start(node, evt) {
        const e = evt;
        e.preventDefault();
        this.targetModel.startBatch('dnd');
        addClass(this.container, 'dragging');
        appendTo(this.container, this.options.draggingContainer || document.body);
    ...
    onDropped(draggingNode) {
        if (this.draggingNode === draggingNode) {
            this.clearDragging();
            removeClass(this.container, 'dragging');
    ...
    getDropArea(elem) {
        const offset$1 = offset(elem);
        const scrollTop = document.body.scrollTop || document.documentElement.scrollTop;
        const scrollLeft = document.body.scrollLeft || document.documentElement.scrollLeft;
        return Rectangle.create({
            x: offset$1.left +
                parseInt(css(elem, 'border-left-width'), 10) -
                scrollLeft,
            y: offset$1.top +
                parseInt(css(elem, 'border-top-width'), 10) -
                scrollTop,
