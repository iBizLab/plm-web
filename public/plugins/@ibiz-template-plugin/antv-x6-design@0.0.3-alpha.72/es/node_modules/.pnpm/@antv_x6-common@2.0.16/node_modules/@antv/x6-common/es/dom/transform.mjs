...
import { isSVGGraphicsElement } from './elem.mjs';
import { transformStringToMatrix, matrixToTransformString, createSVGTransform, parseTransformString, createSVGMatrix } from './matrix.mjs';
...
export { getTransformToElement, getTransformToParentElement, rotate, scale, toLocalPoint, transform, translate };
