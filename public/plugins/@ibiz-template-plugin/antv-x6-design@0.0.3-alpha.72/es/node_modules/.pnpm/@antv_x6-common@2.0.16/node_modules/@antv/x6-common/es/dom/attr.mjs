import { ns } from './elem.mjs';
import { kebabCase } from '../string/format.mjs';
...
export { CASE_SENSITIVE_ATTR, attr, getAttribute, kebablizeAttrs, mergeAttrs, qualifyAttr, removeAttribute, setAttribute, setAttributes, styleToObject };
