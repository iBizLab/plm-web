...
import { createSvgElement } from './elem.mjs';
...
export { KAPPA, circleToPathData, createSlicePathData, ellipseToPathData, getPointsFromSvgElement, lineToPathData, polygonToPathData, polylineToPathData, rectToPathData, rectangleToPathData, sample, toPath, toPathData };
