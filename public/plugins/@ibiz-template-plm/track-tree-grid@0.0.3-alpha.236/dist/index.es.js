...
var j = (r, e, l) => e in r ? O(r, e, { enumerable: !0, configurable: !0, writable: !0, value: l }) : r[e] = l;
var T = (r, e, l) => (j(r, typeof e != "symbol" ? e + "" : e, l), l);
import { TreeService as G, AppDataEntity as P, TreeDataSetNodeData as K, TreeController as $, getControlPanel as V, registerControlProvider as Y } from "@ibiz-template/runtime";
import { useControlController as Z, useNamespace as q, withInstall as U } from "@ibiz-template/vue3-util";
import { createVNode as s, defineComponent as W, ref as S, computed as k, resolveComponent as u, withDirectives as H, resolveDirective as J, isVNode as Q, createTextVNode as _ } from "vue";
import { recursiveIterate as X } from "@ibiz-template/core";
const ee = () => s("svg", {
  viewBox: "0 0 16 16",
...
class re extends G {
   ...
   */
  async getDENodeDatas(e, l, i, o) {
    const { appDEDataSetId: p, appDataEntityId: L, appId: C } = e, { context: x, params: m, navContext: E, navParams: h } = l ? this.getNodeRSFilterParams(l, i, o) : {
      context: o.context,
      params: o.params,
      navContext: {},
      navParams: {}
    };
    m.size = e.maxSize || 1e3, e.sortAppDEFieldId && Object.assign(m, {
    ...
    if (e.userTag === "CUSTOM" && e.treeNodeType === "DE") {
      const f = await ibiz.hub.getAppDataEntity(
        L,
        C
      );
      f && (d = i && i._deData ? i._deData["".concat(e.id)].content || [] : [], d = d.map((v) => new P(f, v)));
    } else
      d = (await this.app.deService.exec(
        L,
        p,
        x,
        m
      )).data;
    return d && d.length > 0 ? d.map((v, w) => {
      const y = this.calcExpand(e, w);
      return new K(e, i, {
        data: v,
        leaf: !!o.leaf,
        navContext: E,
...
class ae extends $ {
  constructor() {
     ...
     */
    T(this, "rowExpandedKeys", []);
  }
  initState() {
    super.initState(), this.state.isRefresh = !1;
  }
  /**
   * 初始化对应类型的部件服务
   * @author lxm
   ...
   */
  async refresh() {
    this.state.isRefresh = !0, super.refresh();
  }
  /**
   ...
   * @return {*}  {Promise<void>}
   */
  async afterLoadNodes(l) {
    this.state.items = [], X(
      { _children: this.state.rootNodes },
      (i) => {
        this.rowExpandedKeys.indexOf(i._id) !== -1 && this.onRowExpandItem(i, !0), this.state.items.push(i);
      },
      { childrenFields: ["_children"] }
    ), this.state.expandedKeys = this.calcExpandedKeys(l);
  }
  /**
   * 行展开收缩切换
   *
   ...
   * @memberof TrackTreeGridController
   */
  onRowExpandItem(l, i = !1) {
    var o;
    Object.assign(l, { _expanded: i }), (o = l._children) == null || o.forEach((p) => {
      this.onRowExpandItem(p, i);
    });
  }
}
function A(r) {
...
const B = /* @__PURE__ */ W({
  ...
  setup() {
    var I;
    const r = Z((...t) => new ae(...t)), e = q("track-tree-grid"), l = S(!1), i = k(() => r.state.isLoaded ? r.state.rootNodes.reduce((t, n) => n._children ? t.concat(n._children) : t, []) : []), o = S([]);
    r.model.detreeNodes && (o.value = (I = r.model.detreeNodes) == null ? void 0 : I.filter((t) => t.treeNodeType === "STATIC" && !t.rootNode).map((t) => {
      let n = !1;
      if (t.userTag) {
        const [a, c] = t.userTag.split("=");
        a === "ENABLESETTING" && (n = c === "true");
      }
      return {
        ...t,
        enableSetting: n,
    ...
    const p = k(() => (i.value[0] || {})._children || []), L = (t, n) => {
      n.stopPropagation(), !t._disableSelect && r.onTreeNodeClick(t, n);
    }, C = (t, n) => {
      n.stopPropagation(), !t._disableSelect && r.onDbTreeNodeClick(t);
    }, x = (t) => {
      const n = r.rowExpandedKeys.indexOf(t._id);
      n !== -1 ? (r.rowExpandedKeys.splice(n, 1), r.onRowExpandItem(t)) : (r.rowExpandedKeys.push(t._id), r.onRowExpandItem(t, !0));
    }, m = (t) => {
      var n;
      Object.assign(t, {
        _expanded: l.value
      }), (n = t._children) == null || n.forEach((a) => {
        m(a);
      });
    }, E = () => {
      l.value = !l.value, m(i.value[0] || {});
    }, h = (t) => {
      const n = r.getNodeModel(t._nodeId) || {}, a = V(n);
      return a ? s(u("iBizControlShell"), {
        data: {
          ...t._deData,
      ...
      const a = n._children || [];
      return s("div", {
        class: [e.e("row"), e.is("expand", n._expanded)]
      }, [s("div", {
        ...
        const g = a.find((b) => b._nodeId === c.id) || {};
        return c.visible && c.enableSetting && w(g);
      })])]);
    }, D = (t, n) => s("div", {
    ...
    }, [n.map((a) => y(t, a))])]), R = (t) => s("div", {
      class: e.e("header"),
      style: {
        minWidth: "".concat(t.length * 20, "rem")
      }
    }, [t.map((n, a) => n.visible && s("div", {
      ...
      class: e.e("table")
    }, [R(o.value), D(o.value, p.value)]), F = () => s(u("el-dropdown"), {
      trigger: "click",
  ...
  render() {
    ...
    }, s(u("iBizControlNavigation"), {
      controller: this.c
    }, {
      default: () => [H(s(u("iBizControlBase"), {
        ref: "treeviewRef",
        controller: this.c
      }, A(r) ? r : {
        default: () => [r]
      }), [[J("loading"), !this.c.state.isRefresh && !this.c.view.state.isLoading && this.c.state.isLoading]])]
    });
  }
});
class le {
  constructor() {
    T(this, "component", "IBizTrackTreeGridControl");
  }
}
const ie = U(
  B,
  function(r) {
    r.component(B.name, B), Y(
...
export {
  ie as IBizTrackTreeGridControl,
  fe as default
};
