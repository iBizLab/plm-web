...
export declare const IBizTrackTreeGridControl: import("@ibiz-template/vue3-util").TypeWithInstall<import("vue").DefineComponent<{
    ...
    c: import("./track-tree-grid.controller").TrackTreeGridController<import("@ibiz/model-core").IDETree, import("./track-tree-grid.controller").ITrackTreeGridState, import("@ibiz-template/runtime").ITreeEvent>;
