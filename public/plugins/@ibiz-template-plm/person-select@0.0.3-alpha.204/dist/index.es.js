...
import { defineComponent as he, ref as S, onMounted as me, watch as O, createVNode as o, computed as W, onBeforeUnmount as ot, resolveComponent as C, mergeProps as ut, withDirectives as ct, resolveDirective as dt, createTextVNode as x, nextTick as pt, isVNode as ht } from "vue";
...
class ft extends st {
  ...
  async getServiceData(a, u, e, c) {
    ...
    const y = this.fill(this.userUrl, r, m, u).replaceAll(
      "//",
      "/"
    ), A = this.fill(this.deptUrl, r, m, u).replaceAll(
      "//",
      "/"
    );
    this.copyUserUrl = y, this.copyDeptUrl = A;
    let f = "post";
    const g = {};
    if (a === "user" ? (P = y, f = this.userMethod.toLowerCase(), f === "get" ? Object.assign(g, { method: f, params: b }) : Object.assign(g, { method: f, data: b })) : (P = A, f = this.deptMethod.toLowerCase(), f === "get" ? Object.assign(g, { method: f, params: b }) : Object.assign(g, { method: f, data: b })), P)
...
const gt = /* @__PURE__ */ he({
  ...
  setup(n, {
    ...
    const a = K("virtual-list"), u = S(36), e = S(), c = S([]), r = S(0), m = S(0), v = S(0), b = S(0), P = () => {
      ...
      b.value = e.value.scrollTop, P(), A(u.value, b.value);
    }, A = (f, g) => {
      h("scrollEvent", f, g);
    };
    return me(() => {
...
class bt {
  ...
  static calcSelItemRenderNum(h, a) {
    ...
    if (a && (h == null ? void 0 : h.length) > 0) {
      const e = (a == null ? void 0 : a.offsetWidth) || 0, c = window.getComputedStyle(a), r = parseInt(c.marginLeft, 10), m = parseInt(c.marginRight, 10), v = parseInt(c.paddingLeft, 10), b = parseInt(c.paddingRight, 10), P = r + m + v + b, y = 30, A = 28, f = 8, g = (A + f) * h.length;
...
const Z = /* @__PURE__ */ he({
  ...
  setup(n, {
    ...
    const a = K("picker-dropdown"), u = K("personel-select"), e = n.controller, c = S(""), r = S([]), m = S([]), v = S(""), b = S(!1), P = S(!1), y = S(""), A = S([]), f = S("user"), g = S([]), F = S(!1), $ = S(!1), D = S(!1), G = S(""), X = S(), U = S(), Y = S();
    let N;
    const z = S(), q = S([]);
    let j = 0;
    const fe = W(() => !!(n.controlParams && n.controlParams.editmode === "hover")), ve = (t) => /^https?:|^http?:|^data:image|(\.png$|\.svg|\.jpg|\.png|\.gif|\.psd|\.tif|\.bmp|\.jpeg)$/.test(t), Q = (t) => {
      ...
      j = bt.calcSelItemRenderNum(t, Y.value), v.value = "", Q(g.value);
    };
    O(() => n.value, (t) => {
      if (t || t === null || t === void 0) {
        if (e.model.valueType === "OBJECT")
          ...
          c.value = t;
        if (t == null) {
          c.value = "", g.value = [], e.parent.form.state.isLoaded && h("change", void 0, e.valueItem), h("blur");
          return;
    ...
    const te = (t) => {
      ...
      y.value && (f.value === "user" ? r.value.unshift(t) : m.value.unshift(t)), e.clearFilter && (y.value = "");
      const s = {};
    ...
    const ae = async (t) => {
      ...
      if (f.value !== t) {
        ...
        f.value === "user" && r.value.length === 0 && (e.resetUserState(), w()), f.value === "department" && m.value.length === 0 && (e.resetDeptState(), w());
      }
    }, Fe = (t) => {
    ...
    }, Ae = (t) => /[\u4E00-\u9FA5]/.test(t), Te = (t) => /[\u4e00-\u9fa5]+.*[a-zA-Z]+|[a-zA-Z]+.*[\u4e00-\u9fa5]+/.test(t), B = (t) => {
      if (!t)
        return "";
      let s = 0;
      ...
      return o("div", {
        ...
        class: a.bem("select-modal", "personel-list", "title-label")
      }, [t[e.suffix]]), i === e.context.srfuserid ? o("div", {
    ...
    }, _e = (t) => y.value ? A.value : t, k = (t) => {
      t.stopPropagation();
    }, Be = (t, s) => {
      $.value && (f.value === "user" ? t - s < 305 && (F.value || w()) : t - s < 250 && (F.value || w()));
    }, re = (t) => {
      var d, E;
    ...
    }, null), o("span", null, ["".concat(e.context.srfusername, "的团队")]), o("span", null, [x("·")]), o("span", null, [e.depttotal])]), b.value ? null : o("div", {
      ...
      if (e.multiple) {
        ...
        if (v.value) {
          ...
          e.isAddSymbol && (d = d.map((M) => M.slice(1, -1))), e.isAddSymbol && (E = E.map((M) => M.slice(1, -1))), d.forEach((M, T) => {
            l.push({
              id: M,
              name: E[T]
            });
      ...
      (i !== e.copyUserUrl || l !== e.copyDeptUrl || n.data && n.data.srfkey !== G.value) && (G.value = ((d = n.data) == null ? void 0 : d.srfkey) || "", r.value = [], m.value = [], e.resetState(), w(!0)), await pt(), (E = X.value) == null || E.focus();
    }, Ze = () => I.value ? ue() : oe(), Ke = () => {
      y.value = "", $.value = !1;
    };
    O(() => n.readonly, (t) => {
